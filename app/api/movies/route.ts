...
/**
 * GET handler for /api/movies endpoint
...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log(`[API Proxy] Forwarding /movies request with params:`, params);
    ...
    const apiUrl = `${API_BASE_URL}/movies`;
    ...
    console.error('[API Proxy] Movies request failed:', error);
